...
export const query = graphql`
  query ResearchThreadQuery($id: String!) {
...
const ResearchThreadTemplate = props => {
  ...
  const page = data && data.researchThread;
  ...
  return (
    <Layout navTranslations={languagePhrases} globalLanguages={globalLanguages} >
      ...
      <Container>
        ...
        <div className="top-text two-column"><BlockContent blocks={(preview && previewData) ? previewData.descriptions : page.descriptions}/></div>
        {/* {media?.length > 0 &&
