function sketch (p) {
    ...
    let opacities = [];
    let indeces = [0, 9, 21,28, 43, 50, 56,63]
    let locations = [
        ...
        "<a href='/exhibition/sakha'>Online with <br>Sakha Artists<br><span>Jul 8, 2024</span><span class='hidden-message'><br>more info</span></a>",
        ...
        "<a href='/exhibition/colombia'>Colombia<br><span>Mar 11 - Apr 3, 2026</span><span class='hidden-message'><br>more info</span></a>",
    ]
    let els = [
